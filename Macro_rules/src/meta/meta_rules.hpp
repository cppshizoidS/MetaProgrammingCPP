...
template <typename T> struct MacroList : meta::parse::list<T> {
  consteval static auto transform(auto ctx) { return unwrap(ctx.value()); }
...
template <TokenType type> struct MacroToken : meta::parse::token<type> {
  consteval static auto transform(auto ctx) {
    return meta::parse::token<type>{};
  }
};

using MacroFragSpec = meta::parse::one_of<meta::parse::ident<fnv1a("number")>,
                                          meta::parse::ident<fnv1a("ident")>,
                                          meta::parse::ident<fnv1a("expr")>>;

struct MacroFragment
    : meta::parse::group<meta::parse::token<TokenType::Dollar>,
                         meta::parse::token<TokenType::Identifier>,
                         meta::parse::token<TokenType::Colon>, MacroFragSpec> {
  consteval static auto transform(auto ctx) {
    constexpr auto name = std::get<1>(ctx.value()).id;
    constexpr auto spec = std::get<3>(ctx.value()).id;

    if constexpr (spec == fnv1a("number")) {
      return meta::parse::with_name<name,
                                    meta::parse::token<TokenType::Number>>{};
    }
    if constexpr (spec == fnv1a("ident")) {
      return meta::parse::with_name<
          name, meta::parse::token<TokenType::Identifier>>{};
    }
...
using MacroRepSep =
    meta::parse::one_of<meta::parse::token<TokenType::Comma>,
                        meta::parse::token<TokenType::Colon>,
                        meta::parse::token<TokenType::Semicolon>>;

using MacroRepOp = meta::parse::one_of<meta::parse::token<TokenType::Plus>,
...
struct MacroRepDef
    : meta::parse::group<meta::parse::token<TokenType::Dollar>,
                         ...
                         meta::parse::opt<MacroRepSep>, MacroRepOp> {
  consteval static auto transform(auto ctx) {
...
struct MacroMatcher
    : meta::parse::one_of<
          meta::parse::group<MacroToken<TokenType::LeftCurly>,
                             MacroList<MacroMatch>,
                             MacroToken<TokenType::RightCurly>>,
          meta::parse::group<MacroToken<TokenType::LeftParen>,
                             MacroList<MacroMatch>,
                             MacroToken<TokenType::RightParen>>,
          meta::parse::group<MacroToken<TokenType::LeftBrace>,
                             MacroList<MacroMatch>,
...
struct MacroMatch
    : meta::parse::one_of<
          MacroRepDef, MacroFragment, MacroIdent, MacroMatcher,
          meta::parse::one_of<
              MacroToken<TokenType::Identifier>, MacroToken<TokenType::Comma>,
              MacroToken<TokenType::Arrow>, MacroToken<TokenType::FatArrow>,
              MacroToken<TokenType::Number>, MacroToken<TokenType::Colon>,
              MacroToken<TokenType::Semicolon>, MacroToken<TokenType::Plus>,
              MacroToken<TokenType::Minus>, MacroToken<TokenType::Asterisk>,
              MacroToken<TokenType::Slash>, MacroToken<TokenType::Tilde>,
              MacroToken<TokenType::Not>, MacroToken<TokenType::Equal>,
