...
TEST( ni_match, match_on_rvalues )
{
    ...
    EXPECT_TRUE(pm::match(get_int())([](int& i){ EXPECT_EQ(1337, i); } ));
    EXPECT_TRUE(pm::match(get_float())([](float& f){ EXPECT_EQ(3.14f, f); } ));
    EXPECT_TRUE(pm::match(get_int())([](int const& i){ EXPECT_EQ(1337, i); } ));
    EXPECT_TRUE(pm::match(get_float())([](float const& f){ EXPECT_EQ(3.14f, f); } ));
}