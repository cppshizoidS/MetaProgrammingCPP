...
struct TypeHierarchyTest : public ::testing::Test
{
    ...
    using Root = pm::type_hierarchy::from_base<TestHierarchyBase>;

    template <typename TargetType>
    static bool convertible_to(Root const& r) { return pm::convertible_to<TargetType>(r); }

    template <typename TargetType>
    static bool convertible_to(Root const* r) { return pm::convertible_to<TargetType>(*r); }

    struct Type_1 : pm::sub_type<Type_1, Root> {};
    struct Type_1_1 : pm::sub_type<Type_1_1, Type_1> {};
    struct Type_1_1_1 : pm::sub_type<Type_1_1_1, Type_1_1> {};
    struct Type_1_1_2 : pm::sub_type<Type_1_1_2, Type_1_1> {};
    struct Type_1_2 : pm::sub_type<Type_1_2, Type_1> {};

    struct Type_2 : pm::sub_type<Type_2, Root> {};
    struct Type_2_1 : pm::sub_type<Type_2_1, Type_2> {};
    struct Type_2_2 : pm::sub_type<Type_2_2, Type_2> {};
...
TEST_F(TypeHierarchyTest, trying_to_cast_across_hierarchies_must_fail_at_compile_time)
{
    ...
    using OtherRoot = pm::type_hierarchy::from_base<OtherHierarchyBase>;
    struct OtherType_1 : pm::sub_type<OtherType_1, OtherRoot> {};

    OtherType_1 ot1;
    OtherRoot& other_r = ot1;
    Root& test_r = x_1;

    EXPECT_TRUE( pm::convertible_to<OtherType_1>(other_r) );
    EXPECT_FALSE( pm::convertible_to<Type_1>(other_r) );
    EXPECT_FALSE( pm::convertible_to<OtherType_1>(test_r) );
}
...
TEST_F(TypeHierarchyTest, very_deep_hierarchy)
{
    ...
    using DeepRoot = pm::type_hierarchy::from_base<DeepHierarchyBase, 2, 2, 2, 2, 2, 2, 2, 2>;
    ...
    r = &d1;
    EXPECT_TRUE( pm::convertible_to<Deep_1>(*r) );

    r = &d2;
    EXPECT_TRUE( pm::convertible_to<Deep_1>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_2>(*r) );

    r = &d3;
    EXPECT_TRUE( pm::convertible_to<Deep_1>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_2>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_3>(*r) );

    r = &d8;
    EXPECT_TRUE( pm::convertible_to<Deep_1>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_2>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_3>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_5>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_6>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_7>(*r) );
    EXPECT_TRUE( pm::convertible_to<Deep_8>(*r) );
}
...
TEST_F(TypeHierarchyTest, for_each_hierarchy_ids_must_start_counting_at_one)
{
    ...
    using Root1 = pm::type_hierarchy::from_base<HierarchyBase1>;
    using Root2 = pm::type_hierarchy::from_base<HierarchyBase2>;

    struct T1_L1 : pm::sub_type<T1_L1, Root1> {};
    struct T1_L2 : pm::sub_type<T1_L2, T1_L1> {};

    struct T2_L1 : pm::sub_type<T2_L1, Root2> {};
    struct T2_L2 : pm::sub_type<T2_L2, T2_L1> {};
...
TEST_F(TypeHierarchyTest, id_type_matches_provided_bits_per_level)
{
    ...
    using DefaultRoot = pm::type_hierarchy::from_base<Base>;
    struct DefaultType : pm::sub_type<DefaultType, DefaultRoot> {};
    DefaultType t;
    EXPECT_LE( 4u, sizeof(t.type_hierarchy_id__()) );

    using Root2x4 = pm::type_hierarchy::from_base<Base, 4, 4>;
    struct Type2x4 : pm::sub_type<DefaultType, Root2x4> {};
    Type2x4 t2x4;
    EXPECT_LE( 1u, sizeof(t2x4.type_hierarchy_id__()) );

    using Root4x4 = pm::type_hierarchy::from_base<Base, 4, 4, 4, 4>;
    struct Type4x4 : pm::sub_type<DefaultType, Root4x4> {};
    Type4x4 t4x4;
    EXPECT_LE( 2u, sizeof(t4x4.type_hierarchy_id__()) );

    using Root4x8 = pm::type_hierarchy::from_base<Base, 8, 8, 8, 8>;
    struct Type4x8 : pm::sub_type<DefaultType, Root4x8> {};
    Type4x8 t4x8;
    EXPECT_LE( 4u, sizeof(t4x8.type_hierarchy_id__()) );

    using Root4x16 = pm::type_hierarchy::from_base<Base, 16, 16, 16, 16>;
    struct Type4x16 : pm::sub_type<DefaultType, Root4x16> {};
    Type4x16 t4x16;
