...
#include "constexpr_hashmap.hpp"

int example_simple() noexcept
{
    static constexpr hmap::ct::hash_map<2, const char*, int> map
    {
...
{
    static constexpr hmap::ct::hash_map<3, std::string_view, std::string_view> map
    {
